...
class Config:
    ...
    def from_env() -> "Config":
        return Config(
            ...
            max_pmids_per_query=int(os.getenv("CARCINOS_MAX_PMIDS", "300")),
            keep_threshold=int(os.getenv("CARCINOS_KEEP_THRESHOLD", "50")),
            high_priority_floor=int(os.getenv("CARCINOS_HIGH_PRIORITY_FLOOR", "40")),
        )
