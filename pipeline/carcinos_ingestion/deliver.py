...
def run_delivery(config: Config, days: int = 7, dry_run: bool = False) -> dict:
    ...
    for sub in subscribers:
        ...
        # Drop any alert whose journal publication date is more than 14 days old.
        # This prevents papers that sat in the review queue from appearing as
        # "this week's" news even though they were approved late.
        pub_cutoff = as_of - timedelta(days=14)
