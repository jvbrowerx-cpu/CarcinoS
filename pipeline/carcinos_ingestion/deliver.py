        ...
        if a.study_design:
            study_row = f"""
              <tr><td style="padding-bottom:10px;">
                <p style="margin:0;font-size:13px;color:{text_mid};font-family:Helvetica,Arial,sans-serif;line-height:1.6;"><strong style="color:{text_dark};">Study / regimen</strong> (high level): {_esc(a.study_design)}</p>
              </td></tr>"""

        # Key findings
        key_findings = a.tier_rationale or a.effect_size or ""
        findings_row = ""
        if key_findings and key_findings.lower() != "manually added by editor":
            findings_row = f"""
              <tr><td style="padding-bottom:10px;">
                <p style="margin:0;font-size:13px;color:{text_dark};font-family:Helvetica,Arial,sans-serif;line-height:1.6;font-weight:600;"><strong>Key findings:</strong> {_esc(key_findings)}</p>
              </td></tr>"""

        # So what / clinical implication
        one_liner_row = ""
        if a.one_liner:
            one_liner_row = f"""
              <tr><td style="padding-bottom:14px;">
                <p style="margin:0;font-size:13px;color:{text_mid};font-family:Helvetica,Arial,sans-serif;line-height:1.6;"><strong style="color:{text_dark};">So what (clinical implication):</strong> {_esc(a.one_liner)}</p>
              </td></tr>"""
