...
from . import gynecologic, thoracic, breast, head_neck, cns, sarcoma, gu, hematologic, cutaneous, gastrointestinal, pediatric
...
ALL_SITES: dict[str, DiseaseSiteConfig] = {
    ...
    pediatric.CONFIG.code:        pediatric.CONFIG,
}
