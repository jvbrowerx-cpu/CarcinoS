...
CONFIG = DiseaseSiteConfig(
    ...
    watched_trials=(
        ...
        "Alliance A071801",    # Phase III single-fraction SRS vs fractionated SRS post-resection brain mets (ASTRO 2026 LBA)
        "NRG-CC009",          # Phase III SRS vs HA-WBRT brain mets from SCLC (ASTRO 2026 LBA)
    ),
)
