...
CONFIG = DiseaseSiteConfig(
    ...
    watched_trials=(
        ...
        "SOFT Preop",         # Phase II SBRT vs chemoRT preoperatively for pancreatic adenocarcinoma (ASTRO 2026 LBA)
        "SABR-COMET",         # Phase II SBRT vs palliative care oligometastatic disease (cross-site)
