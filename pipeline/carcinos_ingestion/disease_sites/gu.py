...
CONFIG = DiseaseSiteConfig(
    ...
    modality_terms=(
        ...
        "Pluvicto", "vipivotide", "rosopatamab",
    ...
    watched_trials=(
        ...
        # Oligometastatic SBRT (cross-site, particularly relevant for prostate/RCC)
        "SABR-COMET",         # Phase II SBRT vs palliative care oligometastatic disease
        "ORIOLE",             # Phase II SABR vs observation oligometastatic prostate
        "STOMP",              # Phase II SABR vs surveillance metastatic castration-sensitive prostate
    ),
)
