...
CONFIG = DiseaseSiteConfig(
    ...
    watched_trials=(
        ...
        "RTOG 1016",          # Cisplatin vs cetuximab + RT HPV+ OPC (landmark negative)
        "De-ESCALaTE HPV",    # Cetuximab vs cisplatin de-escalation HPV+ OPC (UK)
        "CompARE",            # UK phase III comparing altered fractionation H&N
        "ADEPT",              # Adjuvant therapy after transoral surgery high-risk OPC
        # IO + CRT trials
        "KEYNOTE-689",        # Pembrolizumab + CRT vs CRT resectable LA-SCCHN (periop)
        ...
        "JAVELIN HN100",      # Same trial alternate name
