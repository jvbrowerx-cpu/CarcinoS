...
CONFIG = DiseaseSiteConfig(
    ...
    watched_trials=(
        ...
        "STRASS",             # Preoperative RT retroperitoneal STS
        "STRASS2",            # Preoperative chemoRT retroperitoneal STS
        "Axitinib STS",       # Axitinib advanced STS
        # Bone sarcoma
        "EURAMOS-1",          # Osteosarcoma — long-term follow-up (still publishing)
        "MSTS-sarcoma",       # MSTS sarcoma platform
        # GIST
        "INTRIGUE",           # Ripretinib vs sunitinib 2L GIST
        "VOYAGER",            # Avapritinib vs regorafenib GIST
        # Lipo/synovial
