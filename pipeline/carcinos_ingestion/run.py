...
def main(argv: list[str] | None = None) -> int:
    ...
    overall_cost = 0.0
    summaries = []
    # Track PMIDs seen across all sites to prevent cross-site duplicate alerts
    ...
    for code in sites:
        try:
            ...
            # Print CarcinoS card for each alert as it comes in
            for a in alerts:
                _print_card(a)
                if a.candidate.pmid:
                    seen_pmids.add(a.candidate.pmid)
