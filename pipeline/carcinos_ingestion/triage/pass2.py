...
Your ONLY jobs are:
  ...
  (6) Set radiation_oncology_relevance using STRICT criteria:
      direct   = Radiation therapy IS the primary intervention studied: the trial
                 tests RT dose, fractionation, field size, technique, RT vs no RT,
                 or a concurrent RT schedule. Signal type RADONC_TECHNIQUE always → direct.
      ...
      none     = Everything else. Specifically:
                 • Metastatic or advanced-stage disease (RT is only palliative here)
                 • Adjuvant systemic therapy where RT's role is peripheral or elective
                 • Bladder, breast, GU, GI, or hematologic systemic trials not involving CRT
                 • Any trial where RT is NOT a core component of the studied regimen
                 • Hematologic malignancies (RT is rarely standard)
                 • Biomarker or targeted therapy trials
