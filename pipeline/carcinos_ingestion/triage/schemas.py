...
PASS2_SCHEMA = {
    ...
    "schema": {
        ...
        "additionalProperties": False,
        "properties": {
            "cancer_site_subtype": {"type": "string", "maxLength": 160},
            "setting": {
                "type": "string",
                "enum": [
            ...
            "intervention": {"type": "string", "maxLength": 400},
            "comparator": {"type": "string", "maxLength": 400},
            "primary_endpoint": {"type": "string", "maxLength": 280},
            "key_results": {
                "type": "object",
                "additionalProperties": False,
                "properties": {
                    "effect_size": {"type": "string", "maxLength": 700},
                    "p_value_or_ci": {"type": "string", "maxLength": 400},
                    "absolute_difference": {"type": "string", "maxLength": 400},
                    "toxicity_qol_signal": {"type": "string", "maxLength": 600},
                },
                "required": [
                    "effect_size",
                    "p_value_or_ci",
            ...
            "carcinos_one_liner": {"type": "string", "maxLength": 500},
            "evidence_quotes": {
                "type": "array",
            ...
            "radiation_oncology_relevance": {
                ...
                "description": (
                    "direct = RT is the primary intervention: the trial tests RT dose, fractionation, "
                    "field size, technique, RT vs no RT, or a concurrent RT schedule. "
                    "indirect = RT is ESTABLISHED standard of care in this exact disease/stage AND "
                    "this trial changes the systemic agent given WITH or AROUND that RT (e.g., new "
                    "chemotherapy partner in definitive CRT for LAHNSCC, LACC, or LARC). "
                    "none = everything else: metastatic disease, adjuvant systemic trials, "
                    "hematologic malignancies, biomarker/targeted therapy trials, bladder/GU/GI/breast "
                    "systemic trials not involving CRT, or any setting where RT is not a core component. "
                    "Default to none when uncertain — do not over-label as indirect."
                ),
            },
            "confidence": {
                "type": "string",
...
# ─────────────────────────────────────────────────────────────────────────────
# GUIDELINE SCHEMA — dedicated extraction for formal guideline documents.
#
# Used instead of PASS2_SCHEMA when qualifying_signal == "GUIDELINE" or
# study_phase == "guideline_update". Replaces trial-centric fields
# (HR, p-value, ORR) with recommendation-centric fields that produce
# clinically actionable CarcinoS cards.
# ─────────────────────────────────────────────────────────────────────────────
GUIDELINE_SCHEMA = {
    "name": "carcinos_guideline_extraction",
    "strict": True,
    "schema": {
        "type": "object",
        "additionalProperties": False,
        "properties": {
            "guideline_body": {
                "type": "string",
                "maxLength": 120,
                "description": "Issuing organisation. E.g. 'NCCN', 'ASCO', 'ESMO', 'ASTRO', 'ASH', 'EAU', 'NCCN/ESMO'. Use the shortest widely-recognised abbreviation.",
            },
            "guideline_version_or_year": {
                "type": "string",
                "maxLength": 80,
                "description": "Version or year of this guideline document. E.g. 'v2.2026', '2026 Update', 'Version 3.2026'.",
            },
            "disease_area": {
                "type": "string",
                "maxLength": 200,
                "description": "Disease area and setting covered. E.g. 'Non-muscle-invasive bladder cancer (BCG-naïve and BCG-unresponsive)', 'Resectable NSCLC — neoadjuvant and perioperative therapy'.",
            },
            "recommendation_changes": {
                "type": "array",
                "description": "Up to 3 most clinically important recommendation changes in this update. Each entry is a previous→new pair with strength and who should change practice.",
                "minItems": 1,
                "maxItems": 3,
                "items": {
                    "type": "object",
                    ...
                    "properties": {
                        "previous": {
                            "type": "string",
                            "maxLength": 400,
                            "description": "Prior recommendation (or 'New recommendation — not previously addressed' if this is a newly added section).",
                        },
                        "new": {
                            "type": "string",
                            "maxLength": 400,
                            "description": "Updated or new recommendation, stated precisely.",
                        },
                        "strength": {
                            "type": ["string", "null"],
                            "maxLength": 80,
                            "description": "Strength-of-recommendation label as stated in the guideline (e.g. 'Category 1', 'Strong', 'Grade A', 'Conditional'). Null if not reported.",
                        },
                        "who_should_change": {
                            "type": "string",
                            "maxLength": 200,
                            "description": "Which clinicians are most directly affected. E.g. 'Urologists and medical oncologists managing high-risk NMIBC', 'Thoracic surgeons and medical oncologists'.",
                        },
                    },
                    "required": ["previous", "new", "strength", "who_should_change"],
                },
            },
            "evidence_strength": {
                "type": "string",
                "enum": ["A", "B", "C", "D"],
                "description": "A = formal versioned guideline update from a major body (NCCN/ASCO/ESMO/ASTRO/ASH/EAU) with changed recommendations. B = expert consensus with practical guidance. C = informal summary or review paper. D = unclear or insufficient.",
            },
            "carcinos_one_liner": {
                "type": "string",
                "maxLength": 600,
                "description": "One complete sentence summarising what changed and who should act on it. Start with the guideline body and disease area. State the most important new recommendation. Do NOT say 'new standard of care' or 'supports consideration'. Example: 'The 2026 EAU NMIBC guidelines now recommend pembrolizumab as a Category 1 option for BCG-unresponsive high-risk NMIBC, providing the first guideline-endorsed alternative to cystectomy in this setting.'",
            },
            "who_should_care": {
                "type": "array",
                "items": {
            ...
            "reject_recommendation": {
                "type": "boolean",
                "description": "Set true if this is a journal SUMMARY or REVIEW of a guideline rather than the formal guideline document itself, or if no concrete recommendation changes can be extracted from the available text.",
            },
            "why_it_surfaced": {
                "type": "string",
                "maxLength": 400,
